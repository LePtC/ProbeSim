...
左侧显示信息、主菜单、小地图，右侧设计触控按钮

显示剧情对话历史，兼作暂停功能

不要用侧滑，将角速度提到很高，用长按角速度加速的方式，避免无法微操，触控可设定为直接跟随（开始变得像 slither 了…）

QWERTY 键 或组合键代替 F1~F5 ？

Hamper 有接触伤害，插件可堆叠？（越来越像 minecraft 了…）

陷阱插件的用法：丢在整数格地板上（Probe 死亡掉落怎么办…），若陷阱被光照则敌人不敢越过陷阱，若无光照则敌人踩中陷阱被杀死，插件被消耗掉
